...
public class AccountRepositoryTest {
    ...
    public void test_findAll() {
        // when
        List<AccountEntity> accountRepositoryAll = accountRepository.findAll();

        log.debug("Method_Step = {}, accountRepositoryAll = {}", "when", accountRepositoryAll);

        // then
        assertThat(accountRepositoryAll)
                .isEmpty();
    }
}